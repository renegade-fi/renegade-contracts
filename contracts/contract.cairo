...
// @notice returns whether a given nullifier has already been used
...
// @notice adds a new wallet to the commitment tree
...
func update_wallet{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    commitment: felt, match_nullifier: felt, spend_nullifier: felt
) -> (new_root: felt) {
