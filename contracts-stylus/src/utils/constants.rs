...
/// The revert message when the private commitment in a
/// VALID MATCH SETTLE statement does not match the one generated by
/// the user's `VALID REBLIND` proof
#[cfg(any(feature = "core-match-settle", feature = "core-atomic-match-settle",))]
pub const INVALID_PRIVATE_COMMITMENT_ERROR_MESSAGE: &[u8] = b"invalid private commitment";
