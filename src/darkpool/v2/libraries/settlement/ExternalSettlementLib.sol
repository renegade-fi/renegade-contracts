...
library ExternalSettlementLib {
        ...
        returns (uint256 receivedAmount)
    {
        ...
        (settlementContext, receivedAmount) = executeExternalSettlementBundle(
        ...
        returns (uint256 receivedAmount)
    {
        ...
        receivedAmount = externalObligation.amountOut - totalFee;
        ...
        returns (SettlementContext memory settlementContext, uint256 receivedAmount)
    {
        ...
        if (bundleType == SettlementBundleType.NATIVELY_SETTLED_PUBLIC_INTENT) {
            (settlementContext, receivedAmount) = NativeSettledPublicIntentLib.executeBoundedMatch(
            ...
            (settlementContext, receivedAmount) = NativeSettledPrivateIntentLib.executeBoundedMatch(
                matchResult,
            ...
            (settlementContext, receivedAmount) = RenegadeSettledPrivateIntentLib.executeBoundedMatch(
                matchResult,
                externalPartyAmountIn,
                externalPartyRecipient,
                internalPartySettlementBundle,
