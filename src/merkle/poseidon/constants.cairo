//! These constants are ported over from the relayer repo, where they were generated by
//! using the scripts published by the Poseidon authors located here:
...
//! Where the field prime is the hex string of the scalar field prime defined here:
...
//! The round numbers (i.e. R_F = 8 -- R_f = 4 -- and R_P = 56) were generated by
