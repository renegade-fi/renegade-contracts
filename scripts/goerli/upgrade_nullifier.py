"""
Upgrades the nullifier set implementation in the contract
"""
...
async def run(nre: NileRuntimeEnvironment):
    """
    Declares the new nullifier set implementation class and then upgrades the
    pointer in the contract
    """
    ...
    logging.info("\n🕺 Nullifier implementation upgraded!")
