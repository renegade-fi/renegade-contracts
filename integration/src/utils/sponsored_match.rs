...
use crate::{
    ...
    constants::{CONVERSION_RATE_PRECISION, GAS_COST_TOLERANCE},
...
pub async fn setup_sponsored_match_test(
    ...
    if options.in_kind_refund {
        ...
        // Set the conversion rate on `data`
        ...
        data.conversion_rate = U256::from(500_000_000_000_000_000u64);
    }
