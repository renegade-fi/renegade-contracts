...
use renegade_circuits::{
    ...
    zk_circuits::{
        ...
        valid_match_settle::{
            SizedValidMatchSettle, SizedValidMatchSettleStatement, ValidMatchSettleWitness,
        },
...
async fn test_match_settle(args: TestArgs) -> Result<(), eyre::Error> {
    ...
    ) = prove_match_bundle(price, fee_rate, &wallet1, &wallet2, match_result).await?;
